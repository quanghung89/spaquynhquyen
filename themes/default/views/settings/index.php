...
<div class="box">
    <!-- <div class="box-header">
     ...
     <div class="title-menu con-xs-12" style="padding: 40px 0px 30px 0px;">
            ...
            <div class="col-lg-12">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="control-label"
                                   for="time_notice"><?= lang("Thời gian hiện thông báo(Phút)"); ?></label>

                            <?php echo form_input('time_notice', $Settings->time_notice, 'class="form-control tip" id="time_notice"  onkeypress="validate(event)" required="required"'); ?>
                    ...
                    <div class="col-md-4 hidden">
                        <div class="form-group">
                            <label class="control-label"
                                   for="then_day"><?= lang("Sau số ngày"); ?></label>

                            <?php echo form_input('then_day', $Settings->then_day, 'class="form-control tip" id="then_day"  required="required"'); ?>
                    ...
                    <div class="col-md-4 hidden">
                        <div class="form-group">
                            <label class="control-label"
                                   for="pay_multiplication"><?= lang("Lương nhân hệ số"); ?></label>

                            <?php echo form_input('pay_multiplication', $Settings->pay_multiplication, 'class="form-control tip" id="pay_multiplication"  required="required"'); ?>
