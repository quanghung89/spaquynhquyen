<script>
    $(document).ready(function () {
        var oTable = $('#CategoryTable').dataTable({
            ...
            'sAjaxSource': '<?= site_url('system_settings/getTimework') ?>',
...
<div class="box">
   <!--  <div class="box-header">
    ...
    <div class="title-menu con-xs-12" style="margin: 45px 0px;">
                         <span><?= lang('Danh sách giờ làm'); ?></span>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-right" style="padding-right: 20px;margin-bottom: 10px;">
        
       <a data-toggle="modal" data-target="#myModal" href="<?php echo site_url('system_settings/add_timework'); ?>" class="btn btn-warning default "><?= lang('Thêm giờ làm') ?></a>
                    ...
                    <table id="CategoryTable" class="table table-bordered table-hover table-striped">
                        ...
                        <tr>
                          ...
                          <!--   <th style="min-width:40px; width: 40px; text-align: center;"><?= $this->lang->line("image"); ?></th> -->
                            <th><?= $this->lang->line("Mã giờ làm"); ?></th>
                            <th><?= $this->lang->line("Tên giờ làm"); ?></th>
                            <th>Giờ bắt đầu</th>
                            <th>Giờ kết thúc</th>
