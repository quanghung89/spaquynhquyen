<script>
    ...
    $(document).ready(function () {
        var oTable = $('#CategoryTable').dataTable({
            ...
            "aoColumns": [{"bSortable": false, "mRender": checkbox}, null, null,null,{"bSortable": false, "mRender": text_center},{"bSortable": false, "mRender": currencyFormat},null, {"bSortable": false}]
        });


         $('#btnRestTable').click(function(){
            oTable.fnDraw();
            // $('#CusData').data.reload();
        })
...
<div class="box">
   <!--  <div class="box-header">
    ...
    <div class="title-menu con-xs-12" style="margin: 45px 0px;">
                         <span><?= lang('Danh sách dịch vụ'); ?></span>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-right" style="padding-right: 20px;margin-bottom: 10px;">
        
       <a data-toggle="modal" data-target="#myModal" href="<?php echo site_url('system_settings/add_category'); ?>" class="btn btn-warning default "><?= lang('add_category') ?></a>

       <a class="btn btn-primary hidden" id="btnRestTable">12345</a>
                    ...
                    <table id="CategoryTable" class="table table-bordered table-hover table-striped">
                        ...
                        <tr>
                          ...
                          <!--   <th style="min-width:40px; width: 40px; text-align: center;"><?= $this->lang->line("image"); ?></th> -->
                            ...
                            <th><?= $this->lang->line("Danh mục cha"); ?></th>
                            <th><?= $this->lang->line("Thời gian làm(Phút)"); ?></th>
                            <th><?= $this->lang->line("Số tiền"); ?></th>
                            <th><?= $this->lang->line("Nhân viên theo dõi"); ?></th>
