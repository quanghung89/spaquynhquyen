...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <?php $attrib = array('data-toggle' => 'validator', 'role' => 'form','id'=>'add-form-category');
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <div class="controls">
                   <?php
                     ...
                     echo form_dropdown('category_parent', $cate, (isset($_POST['category_parent']) ? $_POST['category_parent'] : ''), 'id="category_parent" class="form-control input-tip select" data-placeholder="' . lang("select") . ' ' . lang("danh mục cha") . '" required="required" style="width:100%;" ');
                     ?>
                </div>
            </div>
            ...
            <div class="form-group">
             ...
             <div class="form-group">
                ...
                <div class="controls">
                    <?php echo form_input('category_time', (isset($_POST['category_time']) ? $_POST['category_time'] : ''), 'class="form-control input-tip" required onkeydown="validateNumber(event);" id="category_time"'); ?>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="controls">
                   <?php
                     ...
                     echo form_dropdown('assign[]', $staf, (isset($_POST['assign']) ? $_POST['assign'] : ''), 'id="assign" multiple class="form-control" data-placeholder="' . lang("select") . ' ' . lang("Nhân viên theo dõi") . '"  style="width:100%;" ');
                     ?>
                </div>
            </div>
