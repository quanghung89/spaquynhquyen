...
<div class="box">
    ...
    <div class="title-menu con-xs-12" style="margin: 45px 0px;">
         <span><?= lang('Danh sách nhóm'); ?></span>
    </div>
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-right" style="padding-right: 20px;margin-bottom: 10px;">
        
       <a data-toggle="modal" data-target="#myModal" href="<?php echo site_url('system_settings/create_group') ?>" class="btn btn-warning default "><?= lang('add_group') ?></a>
