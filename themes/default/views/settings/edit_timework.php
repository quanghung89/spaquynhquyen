...
<script type="text/javascript">
    $("#edit-form-timework").submit(function(e) {
...
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?php echo lang('Sửa giờ làm'); ?></h4>
        </div>
        <?php $attrib = array('data-toggle' => 'validator', 'role' => 'form','id'=>'edit-form-timework');
        echo form_open_multipart("system_settings/edit_timework/".$id, $attrib); ?>
        <div class="modal-body" style="display: inline-block;">
            ...
            <div class="col-md-6 col-xs-12 col-sm-12">
              ...
              <div class="form-group">
                  ...
                  <div class="controls">
                      <?php echo form_input('startime', (isset($_POST['startime']) ? $_POST['startime'] : date('H:i',$inv->sma_timework_starttime)), 'class="form-control input-tip timepicker" onkeypress="return isNumber_time(event,this)"  id="startime" required="required"'); ?>
                  </div>
              </div>
            ...
            <div class="col-md-6 col-xs-12 col-sm-12">
              ...
              <div class="form-group">
                  ...
                  <div class="controls">
                      <?php echo form_input('endtime', (isset($_POST['endtime']) ? $_POST['endtime'] : date('H:i',$inv->sma_timework_endtime)), 'class="form-control input-tip timepicker"  onkeypress="return isNumber_time(event,this)" id="endtime" required="required"'); ?>
                  </div>
              </div>
            </div>
            <!-- <div class="form-group">
        ...
        <div class="modal-footer">
            <?php echo form_submit('edit_category', lang('Sửa'), 'class="btn btn-primary"'); ?>
        </div>
    </div>
    <?php echo form_close(); ?>
</div>
