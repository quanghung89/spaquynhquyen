<div class="modal-dialog modal-lg">
    <div class="modal-content">
        ...
        <div class="title-menu con-xs-12" style="margin: 45px 0px;">
            <span><?php echo ($inv) ? 'Sửa tiền phạt' : 'Thêm tiền phạt'?></span>
        </div>
        <?php $attrib = array('data-toggle' => 'validator', 'role' => 'form', 'id' => 'update-bouns-form');
        echo form_open_multipart("auth/update_fine/".$id, $attrib); ?>
        <div class="modal-body">
            ...
            <div class="row">
                <div class="col-xs-12 col-md-6 col-sm-12 col-lg-6">
                    <div class="form-group">
                        <?= lang("Tiền phạt", "fine"); ?>
                        <input type="text" name="fine" class="form-control formatMoney" value="<?php echo ($inv) ? $this->sma->formatMoney($inv->sma_fine_fine) : 0?>" required id="fine"/>
                ...
                <div class="col-xs-12 col-md-12 col-sm-12 col-lg-12">
                    <div class="form-group">
                        <?= lang('Ghi chú', 'note'); ?>
                        <textarea name="note" id="note" class="pa form-control kb-text note"><?php echo ($inv->sma_fine_note) ? $inv->sma_fine_note : '' ?></textarea>
                    </div>
                </div>
                ...
                <input type="hidden" name="idfine" value="<?php echo $inv->sma_fine_id ?>">
