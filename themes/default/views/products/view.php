                                ...
                                <div class="table-responsive">
                                    <table class="table table-borderless table-striped dfTable table-right-left">
                                       ...
                                       <!--  <?php if ($Owner || $Admin) {
                                        ...
                                        <?php echo '<tr><td>' . $this->lang->line("Giá") . '</td><td>' . $this->sma->formatMoney($product->cost) . '</td></tr>'; ?>
                                                ...
                                                <table
                                                    ...
                                                    <?php foreach ($warehouses as $warehouse) {
                                                        if ($warehouse->quantity != 0) {
                                                            echo '<tr><td>' . $warehouse->name . ' (' . $warehouse->code . ')</td><td class="text-right"><strong>' . $this->sma->formatNumber($warehouse->quantity) . '</strong>' . ($warehouse->rack ? ' (' . $warehouse->rack . ')' : '') . '</td></tr>';
                                                        }
                                                    } ?>
                                                    </tbody>
                                                </table>
