    ...
    $(document).ready(function () {
        ...
        $("#add_item").autocomplete({
            ...
            select: function (event, ui) {
                ...
                if (ui.item.id !== 0) {
                    var i = 0 ;
                    $.each($('#slTable tbody'), function( key, value ) {
                        if($(value).find('.rcode').val() == ui.item.row.code){
                            i++;
                        }
                    });
                    if(i == 0){
                        ...
                        bootbox.alert('Sản phẩm đã tồn tại')
                    }
    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo form_open_multipart("products/add_issue", $attrib);
                if ($quote_id) {
                       ...
                       <!--  <?php if (!$Settings->restrict_user || $Owner || $Admin) { ?>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="">
                                                ...
                                                ?>
                                                <div class="input-group-addon no-print hidden" style="padding: 2px 5px;"><a
                            ...
                            <div class="well well-sm">
                                <div class="form-group" style="margin-bottom:0;">
                                    <div class="input-group wide-tip">
                                        ...
                                        <div class="input-group-addon hidden" style="padding-left: 10px; padding-right: 10px;">
                        ...
                        <div class="col-sm-4 hidden">
                            <div class="form-group">
                                ...
                                echo form_dropdown('payment_status', $pst, 'paid', 'class="form-control input-tip" required="required" id="slpayment_status"'); ?>
                        ...
                        <div class="row" id="bt">
                            <div class="col-md-12">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <?= lang("Nhân viên ghi chú", "slinnote"); ?>
                ...
                <div id="bottom-total" class="well well-sm" style="margin-bottom: 0;">
                    <table class="table table-bordered table-condensed totals" style="margin-bottom:0;">
                        <tr class="warning">
                            ...
                            <td><?= lang('Tổng số lượng') ?> <span class="totals_val pull-right" id="totalq">0</span></td>
                            <td><?= lang('Tổng tiền') ?> <span class="totals_val pull-right" id="total">0.00</span></td>
                ...
                <form class="form-horizontal" role="form">
                 ...
                 <!--    <div class="form-group">
                   ...
                   <!--  <?php if ($Settings->product_discount) { ?>
                    ...
                    <?php } ?> -->
                    <div class="form-group">
                        <label for="pprice" class="col-sm-4 control-label"><?= lang('Giá') ?></label>
