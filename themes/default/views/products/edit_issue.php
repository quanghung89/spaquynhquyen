    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo form_open_multipart("products/edit_issue/" . $inv->id, $attrib)
                ?>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-sm-4 hidden">
                            <div class="form-group">
                                ...
                                echo form_dropdown('sale_status', $sst, 'completed', 'class="form-control input-tip" required="required" id="slsale_status"');
                                ?>
                ...
                <div id="bottom-total" class="well well-sm" style="margin-bottom: 0;">
                    <table class="table table-bordered table-condensed totals" style="margin-bottom:0;">
                        <tr class="warning">
                            ...
                            <td><?= lang('Tổng số lượng') ?> <span class="totals_val pull-right" id="totalq">0.00</span></td>
