    ...
    $(document).ready(function () {
        ...
        $("#add_item").autocomplete({
            ...
            select: function (event, ui) {
                ...
                if (ui.item.id !== 0) {
                    var i = 0 ;
                    $.each($('#poTable tbody'), function( key, value ) {
    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo form_open_multipart("products/add_receipt", $attrib)
                ?>
                    ...
                    <table class="table table-bordered table-condensed totals" style="margin-bottom:0;">
                        <tr class="warning">
                           ...
                           <!--  <?php if ($Settings->tax2) { ?>
                            ...
                            <td><?= lang('Tổng tiền') ?> <span class="totals_val pull-right" id="gtotal">0.00</span></td>
                        </tr>
                    </table>
                </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" id="pr_popover_content">
                <form class="form-horizontal" role="form">
                    ...
                    <?php } ?> -->
                    <div class="form-group">
                        <label for="pcost" class="col-sm-4 control-label"><?= lang('Giá') ?></label>
...
<?php echo '<script type="text/javascript" src="' . $assets . 'js/purchases.js"></script>' ?>
