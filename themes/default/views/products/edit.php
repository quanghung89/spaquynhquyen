    ...
    <div class="box-content">
        <div class="row">
             <?php
                ...
                echo form_open_multipart("products/edit", $attrib)
                ?>
            <div class="col-lg-12">
                ...
                <div class="col-md-6">
                  ...
                  <!--   <div class="form-group standard">
                    ...
                    <div class="form-group all">
                        <?= lang("Giá", "cost") ?>
                        <?= form_input('cost', (isset($_POST['cost']) ? $_POST['cost'] : ($product ? $this->sma->formatDecimal($product->cost) : '')), 'class="form-control tip formatMoney" id="cost" required="required"') ?>
                    </div>
             ...
             <div class="col-lg-12" style="text-align: center;">
                <?php echo form_submit('add_product', lang('Sửa sản phẩm'), 'class="btn btn-warning"'); ?>
