...
|
*/
$config['base_url'] = 'http://ci-spaqq.hk';
...
$config['email'] = Array(
    ...
    'smtp_port' => 465,
    'smtp_user' => 'quanghung.aptech.89@gmail.com', // change it to yours
    'smtp_pass' => 'Monbeou@99', // change it to yours
    'mailtype' => 'text',
    'charset' => 'utf-8',
    'wordwrap' => TRUE
);

$config['emailFrom'] = "quanghung.aptech.89@gmail.com";

$config['danhmucodinh'] = ["Tiền nhà","Tiền điện","Tiền nước"];