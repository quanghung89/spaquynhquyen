...
class MY_Controller extends CI_Controller {
    ...
    function page_construct($page, $meta = array(), $data = array()) {
        ...
        if($user->group_id != 1 || $user->group_id != 2){
            $data['user_warehouse_id'] = $user->warehouse_id;
        }

        $meta['userss'] = $this->site->getUser($this->session->userdata('user_id'));
        ...
        $meta['customerSale'] = $this->site->getAllUserByWarhouseID(null,null,$this->session->userdata('user_id'));
